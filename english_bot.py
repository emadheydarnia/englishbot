...
- بعد از هر جواب:
  ۱. ترجمه صحیح رو نشون بده
  ۲. لغت اصلی رو bold کن
  ۳. ریشه کلمه (word origin/etymology) رو توضیح بده
  ۴. شکل‌های مختلف بده: اسم، فعل، صفت، قید (هر کدوم که وجود داره)
  ۵. یه مثال کاربردی دیگه توی جمله بده
  ۶. اگه collocations مهمی داره بگو
- ۲۰ جمله در هر session
- سطح جملات رو تدریجی سخت‌تر کن (از A2 شروع کن تا B2)
- جملات فارسی باید طبیعی و روزمره باشن
- بعد از ۲۰ جمله گزارش کامل فارسی بده
